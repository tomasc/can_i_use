  ...
  describe UserAgent do
    ...
    describe 'convert user agent to canisue browser key' do
      ...
      describe 'safari' do
        ...
        it { subject.browser_key.must_equal 'safari' }
      end
      ...
      describe 'android' do
        ...
        it { subject.browser_key.must_equal 'android' }
      end
      ...
      describe 'and_uc' do
        ...
        it { subject.browser_key.must_equal 'and_uc' }
      end
    end
